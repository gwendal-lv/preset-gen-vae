...
train.n_epochs = 50  # Total number of epochs (including previous training epochs)
...
# TODO Learning Rate scheduler, etc....
train.optimizer = 'Adam'
train.initial_learning_rate = 1e-4
train.weight_decay = 1e-6
train.scheduler = 'ReduceLROnPlateau'
train.scheduler_factor = 0.1
